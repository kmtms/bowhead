...
realSFS fst index ${saf_prefix}${popa}.saf.idx ${saf_ds_prefix}${popb}.saf.idx -sfs ${sfs} -fstout ${project_name}
...
sfs="${popa}.${popb}.ml"
project_name="${popa}.${popb}"
realSFS fst index ${saf_ds_prefix}${popa}.saf.idx ${saf_prefix}${popb}.saf.idx -sfs ${sfs} -fstout ${project_name}
realSFS fst stats2 ${project_name}.fst.idx -win ${winsize} -step ${stepsize} >${project_name}_slidingwindow